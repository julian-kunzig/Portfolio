...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Julian - Personal Portfolio HTML Template">
        <meta name="keywords" content="Html, Css, jQuery, JavaScript, Julian, onepage, personal, Portfolio, design, creative">
        
        <!-- Title -->
        <title>Julian - Personal Portfolio HTML Template</title>
        <!-- Favicon -->
		...
		<!-- Colors Css -->
        <link rel="stylesheet" href="css/colors/orange_color.css">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <!-- logo -->
                    <a class="navbar-brand" href="#">Julian<span class="brand-after"></span></a>
                </div>
                <!-- Collect the nav links, and other content for toggling -->
                <div class="navbar-links" id="ournavbar">
                    <!-- links -->
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-brand text-center visible-xs-block"><a href="#">Julian<span class="brand-after"></span></a></li>
                ...
                <div class="container">
                    ...
                    <div class="divider">
                        <svg class="wave" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="1920px" height="322.61px" viewBox="0 0 1920 322.61" enable-background="new 0 0 1920 322.61" xml:space="preserve">
                            <path opacity="0.5" fill="#36353b" d="M1920,0.125c-119.022-1.873-267.412,16.756-405.666,93.152
                            ...
                            z"/>
                            <path fill="#2c2a2f" d="M1920,55.904c-99.143-1.178-229.965,20.125-392.831,92.893
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="about-image">
                            <img class="img-responsive" src="images/profile.jpeg" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="about-info">
                            ...
                            <h3>I am Julian Kunzig, I'm a passionate web &amp; mobile developer with 8+ Years of Experience</h3>
                            <p>Prolific, full stack web & mobile developer with a passion for metrics and beating former "best-yets."</p>
                            <p>Prototyped 7 new product features per year for large companies as well as small start ups.</p>
                            <p>Consistently receive high user experience scores for all web development projects, including a 55% increase. Passionate about building world class web applications</p>
        ...
        <!-- jQuery -->
        <script data-cfasync="false" src="https://hasnaanajmi.ga/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="js/jquery-3.2.1.min.js"></script>
        <!-- Bootstrap Js -->
